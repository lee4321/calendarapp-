...
THEME_TO_CONFIG_MAP: dict[tuple[str, str], str] = {
    ...
    ("timeline", "show_continuation_icon"): "timeline_show_continuation_icon",
    ("timeline", "continuation_icon_right"): "timeline_continuation_icon_right",
    ...
    ("blockplan", "show_continuation_icon"): "blockplan_show_continuation_icon",
    ("blockplan", "continuation_icon_right"): "blockplan_continuation_icon_right",
    ("blockplan", "continuation_icon_left"): "blockplan_continuation_icon_left",
    ("blockplan", "continuation_icon_height"): "blockplan_continuation_icon_height",
    ("blockplan", "continuation_icon_color"): "blockplan_continuation_icon_color",

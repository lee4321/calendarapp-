...
THEME_TO_CONFIG_MAP: dict[tuple[str, str], str] = {
    ...
    # Events
    ("events", "font_family"): "event_text_font",
    ("events", "font_color"): "event_text_color",
    ("events", "icon_color"): "event_icon_color",
    ("events", "notes_font"): "event_notes_font",
    ("events", "notes_color"): "event_notes_color",
    ("events", "item_placement_order"): "item_placement_order",
    # Durations
    ("durations", "font_family"): "duration_text_font",
    ("durations", "font_color"): "duration_text_color",
    ("durations", "icon_color"): "duration_icon_color",
    ("durations", "notes_font"): "duration_notes_font",
    ("durations", "notes_color"): "duration_notes_color",
    ...
    ("timeline.notes", "font_family"): "timeline_notes_font",
    ("timeline.notes", "font_color"): "timeline_notes_color",
    ("timeline_events", "name_font_size"): "timeline_event_name_font_size",
    ("timeline_events", "notes_font_size"): "timeline_event_notes_font_size",
    ("timeline_events", "box_width"): "timeline_event_box_width",
    ("timeline_events", "box_height"): "timeline_event_box_height",
    ("timeline_events", "text_color"): "timeline_event_text_color",
    ("timeline_durations", "name_font_size"): "timeline_duration_name_font_size",
    ("timeline_durations", "notes_font_size"): "timeline_duration_notes_font_size",
    ("timeline_durations", "box_width"): "timeline_duration_box_width",
    ("timeline_durations", "box_height"): "timeline_duration_box_height",
    ("timeline_durations", "text_color"): "timeline_duration_text_color",
    ...
    ("blockplan", "event_color"): "blockplan_event_color",
    ...
    ("blockplan", "duration_color"): "blockplan_duration_color",
    ("blockplan", "duration_text_color"): "blockplan_duration_text_color",
    ("blockplan", "duration_notes_color"): "blockplan_duration_notes_color",
    ...
    ("blockplan", "event_font"): "blockplan_event_font",
    ("blockplan", "event_notes_font"): "blockplan_event_notes_font",
    ("blockplan", "event_notes_color"): "blockplan_event_notes_color",
    ("blockplan", "duration_font"): "blockplan_duration_font",
    ("blockplan", "duration_notes_font"): "blockplan_duration_notes_font",
    ...
    ("blockplan", "event_font_size"): "blockplan_event_font_size",
    ("blockplan", "duration_font_size"): "blockplan_duration_font_size",
    ...
    ("compact_plan", "band_font"): "compactplan_band_font",
    ("compact_plan", "band_font_size"): "compactplan_band_font_size",
    ("compact_plan", "band_text_color"): "compactplan_band_text_color",
    ("compact_plan", "band_text_opacity"): "compactplan_band_text_opacity",
    ...
    ("compact_plan", "milestone_label_font"): "compactplan_milestone_label_font",
    ("compact_plan", "milestone_label_font_size"): "compactplan_milestone_label_font_size",
    ("compact_plan", "milestone_label_color"): "compactplan_milestone_label_color",
    ("compact_plan", "milestone_label_opacity"): "compactplan_milestone_label_opacity",
    ("compact_plan", "show_legend"): "compactplan_show_legend",
    ("compact_plan", "legend_font"): "compactplan_legend_font",
    ("compact_plan", "legend_font_size"): "compactplan_legend_font_size",
    ("compact_plan", "legend_label_color"): "compactplan_legend_label_color",
    ("compact_plan", "legend_label_opacity"): "compactplan_legend_label_opacity",
    ...
    ("compact_plan", "milestone_list_font"): "compactplan_milestone_list_font",
    ("compact_plan", "milestone_list_font_size"): "compactplan_milestone_list_font_size",
    ("compact_plan", "milestone_list_date_color"): "compactplan_milestone_list_date_color",
    ("compact_plan", "milestone_list_name_color"): "compactplan_milestone_list_name_color",
    ("compact_plan", "milestone_list_label_opacity"): "compactplan_milestone_list_label_opacity",
    ...
    ("mini_calendar", "nonworkday_shade"): "mini_nonworkday_shade",
    ...
    ("mini_details", "row_font"): "mini_details_row_font",
    ("mini_details", "row_font_size"): "mini_details_row_font_size",
    ("mini_details", "row_color"): "mini_details_row_color",
    ("mini_details", "notes_font"): "mini_details_notes_font",
    ("mini_details", "notes_font_size"): "mini_details_notes_font_size",
    ("mini_details", "notes_color"): "mini_details_notes_color",
...
FONT_KEYS = frozenset({"font_family", "number_font", "notes_font"})
    ...
    def _apply_element_size_rules(self, config: "CalendarConfig") -> None:
        ...
        section_targets: dict[str, list[tuple[str, str]]] = {
            ...
            "mini_details": [
                ...
                ("row_font_size", "mini_details_row_font_size"),
                ("notes_font_size", "mini_details_notes_font_size"),
            ],
            "timeline_events": [
                ("name_font_size", "timeline_event_name_font_size"),
                ("notes_font_size", "timeline_event_notes_font_size"),
            ],
            "timeline_durations": [
                ("name_font_size", "timeline_duration_name_font_size"),
                ("notes_font_size", "timeline_duration_notes_font_size"),
            ],
            "blockplan": [
                ...
                ("event_font_size", "blockplan_event_font_size"),
                ("duration_font_size", "blockplan_duration_font_size"),
            ],
        }
    ...
    def _apply_color_maps(self, config: "CalendarConfig") -> None:
        ...
        if isinstance(mc, dict):
            _MINI_COLOR_FIELDS = {
                ...
                "nonworkday_shade": "theme_mini_nonworkday_shade",

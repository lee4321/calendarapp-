...
THEME_TO_CONFIG_MAP: dict[tuple[str, str], str] = {
    ...
    ("timeline", "duration_side"): "timeline_duration_side",
    ...
    ("compact_plan", "duration_date_column_ratio"): "compactplan_duration_date_column_ratio",
    ("compact_plan", "duration_date_color"): "compactplan_duration_date_color",
    ("compact_plan", "duration_name_color"): "compactplan_duration_name_color",

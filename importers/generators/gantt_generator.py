...
_TASKS: list[dict] = [
    ...
    dict(sid="1", wbs="1", name="Program Management", start=0, days=150, roll=True, grp="PMO", res="Program Director"),
    dict(
        sid="2",
        wbs="1.1",
        ...
        notes="Charter signed by steering committee",
    ),
    dict(
        sid="3",
        wbs="1.2",
        name="Governance Cadence Setup",
        start=1,
        days=4,
        pred="2FS+1d",
        pct=1.0,
    ...
    dict(
        ...
        pct=1.0,
        grp="PMO",
        res="Steering Committee",
    ),
    dict(sid="5", wbs="1.9", name="Steering Review Q2", start=40, days=1, grp="PMO", res="Steering Committee", pri=1),
    dict(sid="6", wbs="1.10", name="Steering Review Q3", start=80, days=1, grp="PMO", res="Steering Committee", pri=1),
    # ── 2 Discovery ───────────────────────────────────────────────────────
    dict(sid="10", wbs="2", name="Discovery", start=2, days=25, roll=True, grp="Delivery"),
    dict(
        sid="11",
        wbs="2.1",
    ...
    dict(
        ...
        pct=0.5,
        grp="Delivery",
        res="Business Analyst,Data Architect",
    ),
    dict(
        sid="15",
        wbs="2.5",
    ...
    # ── 3 Build ───────────────────────────────────────────────────────────
    dict(sid="20", wbs="3", name="Build", start=27, days=60, roll=True, grp="Engineering"),
    dict(sid="21", wbs="3.1", name="Platform Core", start=27, days=35, roll=True, grp="Engineering"),
    dict(
        sid="22",
        wbs="3.1.1",
    ...
    dict(sid="26", wbs="3.2", name="Payments", start=40, days=26, roll=True, grp="Engineering"),
    dict(
        sid="27",
        wbs="3.2.1",
    ...
    dict(sid="30", wbs="3.3", name="Reporting", start=45, days=22, roll=True, grp="Engineering"),
    dict(
        sid="31",
        wbs="3.3.1",
    ...
    # ── 4 Rollout ─────────────────────────────────────────────────────────
    dict(sid="40", wbs="4", name="Rollout", start=88, days=52, roll=True, grp="Operations"),
    dict(
        sid="41",
        wbs="4.1",
        name="Pilot Wave",
    ...
    dict(
        sid="43", wbs="4.3", name="Wave 2", start=108, days=15, pred="42SS+10d", grp="Operations", res="Rollout Manager"
    ),
    dict(
        sid="44", wbs="4.4", name="Hypercare", start=120, days=20, pred="43FF+3ed", grp="Operations", res="Support Lead"
    ),
    dict(
        sid="45",
        wbs="4.5",
    ...
    # ── 5 Closeout ────────────────────────────────────────────────────────
    dict(sid="50", wbs="5", name="Closeout", start=141, days=10, roll=True, grp="PMO"),
    dict(sid="51", wbs="5.1", name="Benefits Review", start=141, days=5, pred="46", grp="PMO", res="PMO Analyst"),
    dict(sid="52", wbs="5.2", name="Lessons Learned", start=144, days=3, pred="51SS+2d", grp="PMO", res="PMO Analyst"),
    dict(
        sid="53",
        wbs="5.3",
        name="Program Close",
    ...
    dict(sid="80", name="Executive Briefing", start=30, days=1, grp="PMO", res="Program Director"),
    dict(
        sid="81",
        name="Weekend Cutover Rehearsal",
        cal=26,
        days=0,
        grp="Operations",
        res="Platform Engineer",
    ...
    dict(sid="82", name="Ad-hoc Risk Review", start=64, days=2, grp="PMO", res="Risk Manager", pri=1),
]

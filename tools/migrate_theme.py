...
style_rules schema described in docs/archive/design_unified_style_rules.html.
...
def emit_theme(theme: OrderedDict) -> str:
    parts: list[str] = []
    parts.append("# Generated by tools/migrate_theme.py — see docs/archive/design_unified_style_rules.html\n\n")
    seen: set[str] = set()
